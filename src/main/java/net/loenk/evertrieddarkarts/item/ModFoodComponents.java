...
public class ModFoodComponents {
    ...
    public static final FoodComponent KINDLED_FORTUNE_BERRY = new FoodComponent.Builder().hunger(5).saturationModifier(0.3f).statusEffect(new StatusEffectInstance(StatusEffects.NAUSEA, 70, 2), 1f).alwaysEdible().build();
}
